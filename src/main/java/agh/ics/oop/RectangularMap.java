...
public class RectangularMap extends AbstractWorldMap implements IInteractiveMap
{
    ...
    public String drawMap() {return visualization.draw(left_corner, right_corner);}
